...
public class TestNGDemo6 {
	...
	@Test(priority=7,dataProvider="getModiProjectData")
	static void modifyProject(String n)
	{
		try
		{
			...
			Thread.sleep(4000);
			oBrowser.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[4]/div[1]/div[2]/div[2]/div/div[2]/input")).sendKeys(n);
			Thread.sleep(2000);
	...
	@DataProvider
	public Object[][] getModiProjectData()
	{
		return new Object[][] {{"Training Website"}};
	}
}
