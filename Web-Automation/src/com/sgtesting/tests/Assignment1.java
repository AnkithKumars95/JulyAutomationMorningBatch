...
public class Assignment1{
	...
	static void enterDetails()
	{
		try
		{
			oBrowser.findElement(By.xpath("//input[@id='name'][@type='text']")).sendKeys("John");
			oBrowser.findElement(By.xpath("//input[@id='email'][@class='form-control']")).sendKeys("John@gmail.com");
			oBrowser.findElement(By.xpath("//input[@id='phone'][@type='number']")).sendKeys("9876543210");
			oBrowser.findElement(By.xpath("//textarea[@id='message'][@placeholder='Message']")).sendKeys("kindly send quote");
			Thread.sleep(1000);
